...
/**
 * Reusability assessment takes item type and ispartofseries 
 * metadata values and taking this into account defines the 
 * structure and granularity level of item entered. This  
 * assessment returns a real number between 0 and 1 to indicate 
 * how reusable is the item assessed, 1 indicates that the item
 * is fully reusable in all educational contexts, meanwhile 0 
 * indicates that this is not very usable appart from the current
 * educational context.   
 * @author Andres Salazar
 */

public class ReusabilityAssess {
	...
	/**
     * Perform the reusability assess upon passed DSO
     *
