...
<dspace:layout style="submission" titlekey="Learning Object Assessment Parametrization"
	...
	Please set the weighting in each dimension in <%=layer%> layer. 
	</span></h3>
	
	<div class="alert alert-warning" role="alert">
	Be aware that for each layer, assigned weights must total 100%!  
	</div>
	
	<form class="form-inline" method="post" action="<%=request.getContextPath()%>/tools/LOAssessment/assess-param">
		...
		<div class="panel panel-info">
			...
			<%
				for (int index = 0;index < checkedDimensions.size();index++) {
					String dimensionName = (String) checkedDimensions.elementAt(index);
			%>
				<div class="input-group">
					<input type="text" class="form-control" aria-describedby="percentage" name="<%=dimensionName%>">
					<%=dimensionName%>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="alert alert-success">
								<strong>Parameterized layer successfully!</strong> Do you want to configure
								a further layer to this assessment?
							</div>
						</div>
						<div class="modal-footer">
							<input class="btn btn-primary pull-right col-md-12" type="submit"
								name="submit_yes" value="Yes" /> 
							<input class="btn btn-primary pull-right col-md-12" type="submit"
