...
DROP TABLE DIM_EXPERT_WEIGHTING CASCADE;
DROP TABLE ASSESSMENT_RESULT CASCADE;
DROP TABLE PERSONAL_ASSESSMENT CASCADE;
...
-- Create all sequences and tables for the module
...
CREATE SEQUENCE dim_expert_weighting_seq INCREMENT 1 START 1;
CREATE TABLE DIM_EXPERT_WEIGHTING ( 
	DIM_EXPERT_WEIGHTING_ID integer DEFAULT nextval(('dim_expert_weighting_seq'::text)::regclass) NOT NULL,
	DIMENSION_WEIGHTING_ID integer,
	EPERSON_ID integer,
...
CREATE SEQUENCE personal_assessment_seq INCREMENT 1 START 1;
CREATE TABLE PERSONAL_ASSESSMENT ( 
	PERSONAL_ASSESSMENT_ID integer DEFAULT nextval(('personal_assessment_seq'::text)::regclass) NOT NULL,
